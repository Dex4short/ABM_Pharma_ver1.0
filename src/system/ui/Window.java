...
public class Window extends JFrame implements Theme{
	...
	public Window() {        
		...
		loading_screen = new LoadingScreen() {
			...
			@Override
			public void onLoading(String load_name) {
				getRootPane().repaint();
			}
		};
	...
	public static void load(Runnable runnable) {
		loading_screen.load(runnable, 1000, main_color[0], main_color[2], "Loading...");
	}
	public static void load(Runnable runnable, String load_name) {
		loading_screen.load(runnable, 0, Shadow.shadow_color, main_color[2], load_name);
	}
}
