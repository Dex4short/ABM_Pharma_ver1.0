...
public class Utilities {
	...
	public static void printStackTraceForDebugging(String message, Thread thread, int trace_length) {
		System.err.print("Debug: " + message + " ");
		
		StackTraceElement traces[] = thread.getStackTrace();
		String file_name;
		int line_number;
		for(int t=2; t<trace_length; t++) {
			file_name = traces[t].getFileName();
			line_number = traces[t].getLineNumber();
			
			System.err.print(" -> (" + file_name + ":" + line_number + ")");
		}
		System.err.println();
	}
}
