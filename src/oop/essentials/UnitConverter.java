...
public class UnitConverter {
	...
	public static BigDecimal getUnitScale(Uom main_uom, UomType uom_type) {
		BigDecimal 
	...
	public static Packaging[] subtractUnits(Packaging packaging, Uom uom1, int qty1, Uom uom2, int qty2) {		
	...
	public static Packaging[] mergePackagings(Packaging packages[]) {
